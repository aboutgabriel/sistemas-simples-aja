    ...
    <footer className="bg-navy text-white py-12 md:py-16">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          {/* Brand */}
          <div>
            {/* “Box” controla a altura para não estourar o footer */}
            <div className="mb-6 h-32 md:h-40 flex items-center">
              <img
                src={grpmLogo}
                alt="GRPM"
                className="max-h-full w-auto object-contain transition-transform duration-300 ease-out hover:scale-105 hover:opacity-90 origin-left"
              />
            </div>
