      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            ...
            <div
              className="flex flex-wrap gap-3 mb-6 opacity-0 animate-fade-in"
              style={{ animationDelay: "0.1s" }}
            >
              {tags.map((tag, index) => (
                <span
                  key={index}
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-accent border border-primary/30 text-sm font-medium text-accent-foreground"
                >
          ...
          {/* Right column — FunnelIllustration */}
          <div
